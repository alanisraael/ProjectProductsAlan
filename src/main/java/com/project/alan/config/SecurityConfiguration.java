package com.project.alan.config;
        ...
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(authorize -> {
                    authorize.requestMatchers(antMatcher("/swagger-ui/**"),
                            ...
                            .requestMatchers(antMatcher(HttpMethod.GET, "/productos")).permitAll()
                            .requestMatchers(antMatcher(HttpMethod.GET, "/productos/**")).permitAll()
                            .requestMatchers(antMatcher(HttpMethod.POST, "/usuarios")).hasRole(UserRole.ADMIN.name())
